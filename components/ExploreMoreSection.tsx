...
const categories = [
  {
    title: "Makeup",
    desc: "From everyday essentials to luxe indulgence find your perfect match",
    img: "/images/t1.png",
  },
  {
    title: "Skin care",
    desc: "From simple skincare to spa-level luxury explore brands you trust",
    img: "/images/t2.jpg",
  },
  {
    title: "Fragrance",
    desc: "Quality fragrances at every price point",
    img: "/images/t3.png",
  },
  {
    title: "Hair care",
    desc: "Explore hair care from brands you love Discover the best in hair care",
    img: "/images/t4.jpg",
  },
];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex items-center justify-center gap-6 mb-6">
              <div className="w-32 h-px bg-gradient-to-r from-transparent to-[#C5A059]"></div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {categories.map((item, i) => (
              <div key={i} className="group">
                ...
                {/* TEXT */}
                <h3 className="mt-6 text-[#D4AF37] text-lg md:text-xl font-medium tracking-wide">
                  {item.title}
                </h3>
                <p className="mt-3 text-[#B8956A] text-sm md:text-base leading-relaxed font-light">
                  {item.desc}
                </p>
              </div>
            ))}
